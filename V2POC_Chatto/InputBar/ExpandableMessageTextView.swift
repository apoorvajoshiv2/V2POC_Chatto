//
//  ExpandableMessageTextView.swift
//  V2POC_Chatto
//
...
open class ExpandableMessageTextView: UITextView {
    ...
    private func commonInit() {
        NotificationCenter.default.addObserver(self, selector: #selector(ExpandableMessageTextView.textDidChange), name: NSNotification.Name.UITextViewTextDidChange, object: self)
